...
STAGES = [
    ...
    stage("F", "Offline preview seal",
          "Gate 4 bound.",
          ["Deterministic offline graph", "Pricing", "Assets", "QTI", "Student-surface preview — all offline"],
          "OFFLINE_PREVIEW_SEALED packet (Gate 5, runbook Phases 1-3).",
          [1, 4], "Earliest affected gate.", "Sealed offline artifacts and deterministic rerun receipts.",
          "COMPLETE",
          {"level": "in_progress", "note": "HumGeo's live edge as of 2026-08-26; no course has sealed it."},
          []),
