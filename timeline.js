...
*/
const AP4_DASHBOARD = {
  snapshot: 'Aug 30, 2026 · 13:29 KST',
  activeCourse: 'humgeo',
  gates: [
    ...
    { id: 5, name: 'Graph + preview', canonCode: 'P1-3', railName: 'Graph + preview', canonName: 'Phases 1-3 · Offline graph and student-surface preview', state: 'active', status: 'In progress · 528 assets locally validated', detail: 'Five enriched lessons and 440/440 operator-receipt article checks are landed. Phase 3.1-3.2 has 88 script-free XHTML files plus 440 two-attempt QTI packages locally validated. The formal census contract, bank-wide validation, governed-surface QTI checks, and student preview remain.' },
  ...
  courses: [
    {
      ...
      status: 'Phases 1-3 · IN PROGRESS', statusTone: 'blue', mapping: 'Runbook-canon lifecycle', observed: 'Aug 30 · 04:19Z',
  ...
  evidenceMaps: {
    humgeo: {
      ...
      note: 'Accepted source and Phase 0 retain closure credit. Phases 1-3 are IN PROGRESS: five enriched lessons and 440/440 operator-receipt checks are landed, and 528 Phase 3.1-3.2 assets pass local validation. The formal census contract and governed-surface checks remain.',
      rows: [
        ...
        { gate: 5, state: 'active', status: 'In progress', signal: '528 assets locally validated · formal census contract open', copy: 'Five enriched lessons and all 440 operator-receipt checks are landed. Local validation covers 88 script-free XHTML files and 440 two-attempt QTI packages; upload and governed-surface validation remain.', href: 'humgeo.html' }
      ]
    },
    apwh: {
