...
```json
{
  ...
  "claims": [
    ...
    {"claim_id": "psych.ebq.zero_yield", "section": "Psych", "status": "OBSERVED", "observed_at": "2026-08-11", "value": "evidence-based-FRQ generation produced 0 usable items in 10 passes; fresh measurement is PLANNED on the first two fill cycles; 221 of the 374 short buckets need this generator", "evidence": [{"type": "seat-receipts", "location": "seat receipt — sanitized Drive copy being staged (folder: https://drive.google.com/drive/folders/1gfqL4L9-hE0N32FIDu-E_qn8IQiQjXj7)"}], "evidence_access": "JOSH_MACHINE_ONLY"},
