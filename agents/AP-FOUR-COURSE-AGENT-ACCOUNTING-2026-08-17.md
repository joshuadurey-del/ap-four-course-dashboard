...
```json
{
  ...
  "claims": [
    {"claim_id": "humgeo.rebuild.passes", "section": "HumGeo", "status": "OBSERVED", "observed_at": "2026-08-18T04:25+09:00", "value": "451/474 slots hold current-byte official /v1/qc passes. The state file counts 463 accepted; 12 of those fail the official check on one field (pre-amendment expected_old pin), so 451 is the seal-ready figure", "scope": "regeneration campaign slots only", "excluded": ["6 metadata rows", "759-line structural cohort"], "evidence": [{"type": "state-snapshot", "url": "https://drive.google.com/file/d/1gJayI66bbayK0GrfsCOocZhBBgmbnWzD/view", "note": "sanitized snapshot, 2026-08-17 15:00 KST"}, {"type": "git-branch", "url": "https://github.com/joshuadurey-del/ap-ss-evidence/tree/b6f5f1e8f585633f16f6733f8b9b315a9426d3ac/evidence/humgeo/20260816-004715__claude__humgeo--adoption-verifications/claude", "commit": "b6f5f1e8f585633f16f6733f8b9b315a9426d3ac"}], "evidence_access": "ILMA_HUMAN_ONLY+SHARED_VIA_DRIVE", "verification": "run_issue21_bulk_qc.py --plan <amended> --plan-only reports official_current_byte_passes_reused=449, selected=25; the runner's own _official_pass check, not the state file's status field"},
    ...
    {"claim_id": "humgeo.amendment.sealed", "section": "HumGeo", "status": "OBSERVED", "observed_at": "2026-08-17 (sha recomputed from bytes)", "value": "30-slot amendment sealed; plan sha256 91310a145f03358b03dadb7a7b9d48235b8bf628f15e3d9ef09508fe6896edbc (recomputed from bytes today); sandbox proof 425 prior passes intact / 49 slots selected", "scope": "plan + sandbox proof", "excluded": ["execution"], "evidence": [{"type": "git-branch", "url": "https://github.com/joshuadurey-del/ap-ss-evidence/tree/d1f7902ddefa510b5e2dc970f96ecbf001b167c6/evidence/humgeo/20260817-000500__claude__humgeo--amend30-docs/claude", "commit": "d1f7902ddefa510b5e2dc970f96ecbf001b167c6"}, {"type": "langfuse-trace", "id": "c0b6a4f2b09a5b1494a87f474dcffd8e"}], "evidence_access": "ILMA_HUMAN_ONLY+SHARED_AFTER_INVITE"},
    ...
    {"claim_id": "humgeo.metadata6.qc", "section": "HumGeo", "status": "OBSERVED", "value": "all 6 metadata rows COMPLETED official /v1/qc: 3 pass (5.8-f1-r00, 5.8-f1-a00, 5.8-f2-a02), 3 FAIL (5.8-f1-r01 S6+S7, 5.8-f2-a00 C2, 5.8-f2-a01 S8). Verdicts persisted with judged fingerprints on all 6", "evidence": [{"type": "qc-intents", "url": "https://drive.google.com/file/d/10b_AYqrqVbVgBh9NXodx2QoWGVTUm9lP/view", "note": "sanitized copy"}], "evidence_access": "SHARED_VIA_DRIVE", "observed_at": "2026-08-18T03:31+09:00", "scope": "the 6 metadata candidate records", "excluded": ["repair or regeneration of the 3 failures — not yet scoped"], "verification": "scripts/service_qc.py --items issue21-metadata-candidates-6 --refresh (committed factory-QC runner, POST /v1/qc); re-read each record's qc.service.passed"},
    ...
    {"claim_id": "humgeo.repair759.staged", "section": "HumGeo", "status": "OBSERVED", "observed_at": "2026-08-16T13:17+09:00", "value": "741 of 759 structural-repair candidates staged with receipts", "scope": "staging only; no official verdicts yet", "excluded": ["18 non-staged (multi-check or nonconverged, dispositioned to regenerate)"], "evidence": [{"type": "git-branch", "url": "https://github.com/joshuadurey-del/ap-ss-evidence/tree/b26d5a2ff43de8820e729c28c23e236abad3c370/evidence/humgeo/20260816-052500__claude__humgeo--repair-docs/claude", "commit": "b26d5a2ff43de8820e729c28c23e236abad3c370"}, {"type": "langfuse-trace", "id": "3403d1909af058139c970c8e304658b5", "dataset": "humgeo-structural-repair-20260816", "run": "final-1317kst"}], "evidence_access": "ILMA_HUMAN_ONLY+SHARED_AFTER_INVITE"},
    ...
    {"claim_id": "psych.articles", "section": "Psych", "status": "OBSERVED", "observed_at": "2026-08-17", "value": "221/221 articles complete, every EK covered (U5's 54 landed 2026-08-16)", "evidence": [{"type": "git-branch", "url": "https://github.com/joshuadurey-del/ap-ss-evidence/tree/564d0866336d71bb467b28d02d1d123e4adf82ee/evidence/psych/20260817-local-host/claude", "commit": "564d086", "note": "re-walked after the fleet repair train: 221/221 green at rebuilt bundle"}], "evidence_access": "ILMA_HUMAN_ONLY"},
    ...
    {"claim_id": "psych.local_serving", "section": "Psych", "status": "OBSERVED", "observed_at": "2026-08-17", "value": "boot-on-demand serving proven: the real BFF app booted in-process over the assembled bundle (262 components); 221/221 article student-views served; tree exact; zero key leaks; 246 receipts; reproducible on one documented command (WALK-SUMMARY.md in the evidence branch)", "scope": "article-serving paths only", "excluded": ["gate paths", "practice paths — bank-gated, unmeasured"], "evidence": [{"type": "git-branch", "url": "https://github.com/joshuadurey-del/ap-ss-evidence/tree/564d0866336d71bb467b28d02d1d123e4adf82ee/evidence/psych/20260817-local-host/claude", "commit": "564d086", "note": "re-walked after the fleet repair train: 221/221 green at rebuilt bundle"}], "evidence_access": "ILMA_HUMAN_ONLY"},
    ...
    {"claim_id": "psych.registration", "section": "Psych", "status": "PLANNED", "value": "PARKED BY OWNER RULING (no repo noise), not a blocker: the prepared branch f7b40cca on InceptTrilogy/ap-one (builder + bundle + registration entry, body gate-passed) stays staged; it opens as ONE complete-course PR when three conditions hold — U5 gate green, bank full, gate/practice snapshots walked", "evidence": [{"type": "git-branch", "id": "f7b40cca on InceptTrilogy/ap-one", "note": "staged registration branch"}], "evidence_access": "SHARED"},
    {"claim_id": "cross.pool_chain", "section": "Cross-course", "status": "PLANNED", "value": "serial factory-pool order: HumGeo close-out, then APWH 362 + sweep, then APUSH 74, then Psych fill; each handoff writes a receipt the next lane fires on; Stage-4 prep receipts already OBSERVED", "evidence": [{"type": "git-branch", "url": "https://github.com/joshuadurey-del/ap-ss-evidence/tree/f05a665d52a31707a72c2d76d5271b2f5a02db60/evidence/seat/20260817-apush-stage4-prep", "commit": "f05a665d52a31707a72c2d76d5271b2f5a02db60"}], "evidence_access": "ILMA_HUMAN_ONLY"},
...
**humgeo.rebuild.passes — 451/474 official passes** · `OBSERVED` 2026-08-18T04:25+09:00
...
- Verify now: do NOT recount rows with status accepted — that gives 463 and overstates it. Run the runner's own eligibility check (`--plan-only` reports official_current_byte_passes_reused=451); 12 accepted rows stamp pre-amendment expected_old pins and fail it; the adoption-time verification of the then-425 passes is published at [adoption-verifications](https://github.com/joshuadurey-del/ap-ss-evidence/tree/b6f5f1e8f585633f16f6733f8b9b315a9426d3ac/evidence/humgeo/20260816-004715__claude__humgeo--adoption-verifications/claude) (`b6f5f1e8f585633f16f6733f8b9b315a9426d3ac`).
...
- Sandbox proof: 425 prior passes intact, 49 slots selected. Ceremony, authority citation, and draft hashes: [amend30-docs](https://github.com/joshuadurey-del/ap-ss-evidence/tree/d1f7902ddefa510b5e2dc970f96ecbf001b167c6/evidence/humgeo/20260817-000500__claude__humgeo--amend30-docs/claude) (`d1f7902ddefa510b5e2dc970f96ecbf001b167c6`); Langfuse trace `c0b6a4f2b09a5b1494a87f474dcffd8e`.
...
- Receipts: [repair-docs](https://github.com/joshuadurey-del/ap-ss-evidence/tree/b26d5a2ff43de8820e729c28c23e236abad3c370/evidence/humgeo/20260816-052500__claude__humgeo--repair-docs/claude) (`b26d5a2ff43de8820e729c28c23e236abad3c370`).
